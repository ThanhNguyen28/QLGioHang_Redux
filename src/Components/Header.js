      ...
      return (
        ...
        >
          ...
          <li>
            <ul className="social">
              <li>
                <a href="thanh.html"  className="icons-sm fb-ic">
                  <i className="fa fa-facebook"> </i>
                </a>
              </li>
              <li>
                <a href="thanh.html"  className="icons-sm pin-ic">
                  <i className="fa fa-pinterest"> </i>
                </a>
              </li>
              <li>
                <a href="thanh.html"  className="icons-sm gplus-ic">
                  <i className="fa fa-google-plus"> </i>
                </a>
              </li>
              <li>
                <a href="thanh.html"  className="icons-sm tw-ic">
          ...
          <li>
            <ul className="collapsible collapsible-accordion">
              <li>
                <a href="thanh.html"  className="collapsible-header waves-effect arrow-r">
              ...
              <li className="active">
                <a href="thanh.html"  className="collapsible-header waves-effect arrow-r active">
                  ...
                  <ul>
                    ...
                    <li>
                      <a
                        ...
                        >Ecommerce homepage V.3 Full Page Carousel</a
                      >
                    </li>
                    <li>
                      <a
                        ...
                        className="waves-effect"
                        >Ecommerce homepage V.3 Half Page Carousel</a
                      >
                    </li>
                    <li>
                      <a href="home-page-4.html" className="waves-effect"
                        >Ecommerce homepage V.4</a
                      >
                    </li>
                  </ul>
                </div>
                  ...
                  <ul>
                    ...
                    <li>
                      <a
                        ...
                        className="waves-effect"
                        >Full width page with not logged user</a
                      >
                    </li>
                  </ul>
                </div>
                  ...
                  <ul>
                    <li>
                      <a
                        ...
                        className="waves-effect"
                        >Category list with left column</a
                      >
                    </li>
                    <li>
                      <a
                        ...
                        className="waves-effect"
                        >Category list with right column</a
                      >
                    </li>
                    <li>
                      <a
                        ...
                        className="waves-effect"
                        >Category grid with left column</a
                      >
                    </li>
                    <li>
                      <a href="category-right-column.html" className="waves-effect"
                        >Category grid with right column</a
                      >
                    </li>
                    <li>
                      <a
                        ...
                        className="waves-effect"
                        >Category grid with left column carousel</a
                      >
                    </li>
                  </ul>
                </div>
        ...
        >
          <div className="float-left">
            <a href="thanh.html" data-activates="slide-out" className="button-collapse">
          ...
          <ul className="nav navbar-nav nav-flex-icons ml-auto">
            <li className="nav-item dropdown">
              ...
              >
                <p className="dropdown-item waves-effect waves-light">Đăng Ký</p>
                <p className="dropdown-item waves-effect waves-light">Đăng Nhập</p>
                <p className="dropdown-item waves-effect waves-light">Đăng Xuất</p>
              </div>
            </li>
          </ul>
        </nav>
